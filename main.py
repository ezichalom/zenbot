...
async def mercari_loop():
    while True:
        ...
        for keyword in KEYWORDS:
            ...
            # SCANNER
            items += scrape_mercari(
                f"https://jp.mercari.com/search?keyword={keyword}&sort=price&order=asc",
                "scan_"
            )
